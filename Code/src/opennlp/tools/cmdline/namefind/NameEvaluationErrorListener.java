...
/**
 * A default implementation of {@link opennlp.tools.util.eval.EvaluationMonitor} that prints
 * to an output stream.
 * 
 */
public class NameEvaluationErrorListener extends
  ...
  /**
   * Creates a listener that will print to a given {@link java.io.OutputStream}
   */
