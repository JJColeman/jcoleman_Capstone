...
public class ArgumentParser {
  ...
  static {
    Map<Class<?>, ArgumentFactory> factories = new HashMap<Class<?>, ArgumentFactory>();
   ...
   * incorrectly. Incorrectly is defined as {@link opennlp.tools.cmdline.ArgumentParser#validateArguments(String[], Class)}
   * returns false.
   *
  ...
  /**
   * Creates a usage string which can be printed in case the user did specify the arguments
   * incorrectly. Incorrectly is defined as {@link opennlp.tools.cmdline.ArgumentParser#validateArguments(String[],
   * Class[])}
   * returns false.
   * 
   ...
   * is checked by the {@link opennlp.tools.cmdline.ArgumentParser#parse(String[], Class)} method and reported accordingly.
   *
