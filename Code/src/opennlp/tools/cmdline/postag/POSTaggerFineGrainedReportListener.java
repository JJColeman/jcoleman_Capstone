...
public class POSTaggerFineGrainedReportListener implements
  ...
  /**
   * Creates a listener that prints to a given {@link java.io.OutputStream}
   */
  ...
  /**
   * Writes the report to the {@link java.io.OutputStream}. Should be called only after
  ...
  private static class ConfusionMatrixLine {
    ...
    /**
     * Creates a new {@link opennlp.tools.cmdline.postag.POSTaggerFineGrainedReportListener.ConfusionMatrixLine}
     * 
     * @param ref
