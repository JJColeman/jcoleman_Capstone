...
public class POSDictionary implements Iterable<String>, MutableTagDictionary {
  ...
  /**
   * Initializes an empty case sensitive {@link opennlp.tools.postag.POSDictionary}.
   */
  ...
  /**
   * Initializes an empty {@link opennlp.tools.postag.POSDictionary}.
   * @param caseSensitive the {@link opennlp.tools.postag.POSDictionary} case sensitivity
   */
   ...
   *
   * @throws java.io.IOException when the specified file can not be read.
   * 
   * @deprecated Use {@link opennlp.tools.postag.POSDictionary#create(java.io.InputStream)} instead, old format might removed.
   */
  @Deprecated
  ...
  /**
   * Writes the {@link opennlp.tools.postag.POSDictionary} to the given {@link java.io.OutputStream};
   *
   * After the serialization is finished the provided
   * {@link java.io.OutputStream} remains open.
   *
   * @param out
   *            the {@link java.io.OutputStream} to write the dictionary into.
   *
   * @throws java.io.IOException
   *             if writing to the {@link java.io.OutputStream} fails
   */
  ...
  /**
   * Creates a new {@link opennlp.tools.postag.POSDictionary} from a provided {@link java.io.InputStream}.
   *
   * After creation is finished the provided {@link java.io.InputStream} is closed.
   *
   * @param in
   *
