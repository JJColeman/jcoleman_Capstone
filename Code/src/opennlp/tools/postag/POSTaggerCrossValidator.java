...
public class POSTaggerCrossValidator {
  ...
  /**
   * Creates a {@link opennlp.tools.postag.POSTaggerCrossValidator} that builds a ngram dictionary
  ...
  /**
   * Creates a {@link opennlp.tools.postag.POSTaggerCrossValidator} using the given
  ...
  /**
   * @deprecated use
   *             {@link #POSTaggerCrossValidator(String, opennlp.tools.util.TrainingParameters, POSTaggerFactory, POSTaggerEvaluationMonitor...)}
   *             instead and pass in a {@link opennlp.tools.util.TrainingParameters} object and a
   *             {@link POSTaggerFactory}.
   */
  ...
  /**
   * @deprecated use
   *             {@link #POSTaggerCrossValidator(String, opennlp.tools.util.TrainingParameters, POSDictionary, Integer, String, POSTaggerEvaluationMonitor...)}
