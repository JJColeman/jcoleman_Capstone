...
/**
 * The {@link opennlp.tools.postag.POSModel} is the model used
...
public final class POSModel extends BaseModel {
  ...
  /**
   * @deprecated Use
   *             {@link #POSModel(String, opennlp.tools.ml.model.AbstractModel, java.util.Map, POSTaggerFactory)}
   *             instead.
   */
   ...
   * 
   * @deprecated Use {@link opennlp.tools.postag.POSModel#getFactory()} to get a
