...
/**
 * This class reads the {@link POSSample}s from the given {@link java.util.Iterator}
 * and converts the {@link POSSample}s into {@link opennlp.tools.ml.model.Event}s which
...
public class POSSampleEventStream extends AbstractEventStream<POSSample> {
   ...
   * to create the training {@link opennlp.tools.ml.model.Event}s.
   */
