...
public class DocumentCategorizerME implements DocumentCategorizer {
  ...
  /**
   * Initializes the current instance with the given {@link opennlp.tools.ml.model.MaxentModel}.
   *
   * @param model
   * 
   * @deprecated Use {@link opennlp.tools.doccat.DocumentCategorizerME#DocumentCategorizerME(DoccatModel)} instead.
   */
  @Deprecated
  ...
  /**
   * Initializes the current instance with a the given {@link opennlp.tools.ml.model.MaxentModel}
   * and {@link FeatureGenerator}s.
   *
   * @param model
   * @param featureGenerators
   * 
   * @deprecated Use {@link opennlp.tools.doccat.DocumentCategorizerME#DocumentCategorizerME(DoccatModel, FeatureGenerator...)} instead.
   */
  @Deprecated
  public DocumentCategorizerME(MaxentModel model,
  ...
  /**
   * Trains a new model for the {@link opennlp.tools.doccat.DocumentCategorizerME}.
   *
   * @param eventStream
   *
