...
public class TokenizerFactory extends BaseToolFactory {
  ...
  /**
   * Creates a {@link opennlp.tools.tokenize.TokenizerFactory} that provides the default implementation
   * of the resources.
   */
  ...
  /**
   * Creates a {@link opennlp.tools.tokenize.TokenizerFactory}. Use this constructor to
   ...
   *          "^[A-Za-z0-9]+$", provided by {@link opennlp.tools.tokenize.lang.Factory#DEFAULT_ALPHANUMERIC}
   */
  ...
  /**
   * Factory method the framework uses create a new {@link opennlp.tools.tokenize.TokenizerFactory}.
   */
