 ...
 * to safe memory.
 * <p>
 * To train a new model {{@link #train(String, opennlp.tools.util.ObjectStream, boolean, opennlp.tools.util.TrainingParameters)} method
 * can be used.
 * <p>
 * Sample usage:
 * <p>
...
public class TokenizerME extends AbstractTokenizer {
   ...
   * @deprecated As of release 1.5.2, replaced by {@link opennlp.tools.tokenize.lang.Factory#getAlphanumeric(String)}
   */
  @Deprecated
   ...
   * calls to {@link opennlp.tools.tokenize.TokenizerME#tokenize(String)} or {@link opennlp.tools.tokenize.TokenizerME#tokenizePos(String)}.
   *
  ...
  /**
   * Trains a model for the {@link opennlp.tools.tokenize.TokenizerME}.
   * 
   * @param samples
   ...
   *           it throws an {@link java.io.IOException} if an {@link java.io.IOException} is
   *           thrown during IO operations on a temp file which is created
   *           during training. Or if reading from the {@link opennlp.tools.util.ObjectStream}
   *           fails.
   */
   ...
   * @return the trained {@link TokenizerModel}
   *
   * @throws java.io.IOException it throws an {@link java.io.IOException} if an {@link java.io.IOException}
   * is thrown during IO operations on a temp file which is created during training.
   * Or if reading from the {@link opennlp.tools.util.ObjectStream} fails.
   * 
   * @deprecated Use 
   *    {@link #train(String, opennlp.tools.util.ObjectStream, TokenizerFactory, opennlp.tools.util.TrainingParameters)}
  ...
  /**
   * Trains a model for the {@link opennlp.tools.tokenize.TokenizerME} with a default cutoff of 5 and 100 iterations.
   *
   * @param languageCode the language of the natural text
   * @param samples the samples used for the training.
   * @param useAlphaNumericOptimization - if true alpha numerics are skipped
   ...
   * 
   * @throws java.io.ObjectStreamException if reading from the {@link opennlp.tools.util.ObjectStream} fails
