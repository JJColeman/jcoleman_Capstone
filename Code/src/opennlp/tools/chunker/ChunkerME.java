...
public class ChunkerME implements Chunker {
   ...
   * @param sequenceValidator  The {@link opennlp.tools.util.SequenceValidator} to determines whether the outcome
   ...
   *    and use the {@link ChunkerFactory} to configure the {@link opennlp.tools.util.SequenceValidator} and {@link ChunkerContextGenerator}.
   */
   ...
   *        on what sequences are valid.
   * @deprecated Use {@link #ChunkerME(ChunkerModel, int)} instead 
   *    and use the {@link ChunkerFactory} to configure the {@link opennlp.tools.util.SequenceValidator}.
   */
  ...
  /**
   * @deprecated Use
   *             {@link #train(String, opennlp.tools.util.ObjectStream, ChunkerContextGenerator, opennlp.tools.util.TrainingParameters, ChunkerFactory)}
   *             instead.
   */
  public static ChunkerModel train(String lang, ObjectStream<ChunkSample> in, 
  ...
  /**
   * @deprecated use {@link #train(String, opennlp.tools.util.ObjectStream, ChunkerContextGenerator, opennlp.tools.util.TrainingParameters)}
  ...
  /**
   * Trains a new model for the {@link opennlp.tools.chunker.ChunkerME}.
   *
   * @param in
   * @param cutoff
   * @param iterations
