...
public class ChunkerCrossValidator {
  ...
  /**
   * @deprecated Use
   *             {@link #ChunkerCrossValidator(String, opennlp.tools.util.TrainingParameters, ChunkerFactory, ChunkerEvaluationMonitor...)}
   *             instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link #ChunkerCrossValidator(String, opennlp.tools.util.TrainingParameters, ChunkerFactory, ChunkerEvaluationMonitor...)} instead.
   */
