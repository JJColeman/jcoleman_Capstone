...
/**
 * The {@link opennlp.tools.util.featuregen.AggregatedFeatureGenerator} aggregates a set of
...
public class AggregatedFeatureGenerator implements AdaptiveFeatureGenerator {
  ...
  /**
   * Calls the {@link AdaptiveFeatureGenerator#createFeatures(java.util.List, String[], int, String[])}
  ...
  /**
   * Retrieves a {@link java.util.Collections} of all aggregated
