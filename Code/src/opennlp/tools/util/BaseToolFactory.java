 ...
 * {@link opennlp.tools.util.model.ArtifactProvider} and calls {@link #BaseToolFactory(java.util.Map)} <li>override
...
public abstract class BaseToolFactory {
  ...
  */
  ...
  /**
   * Creates a {@link java.util.Map} with pairs of keys and {@link opennlp.tools.util.model.ArtifactSerializer}.
   * The models implementation should call this method from
   * {@link opennlp.tools.util.model.BaseModel#createArtifactSerializersMap}
   * <p>
   * The base implementation will return a {@link java.util.HashMap} that should be
  ...
  /**
   * Creates a {@link java.util.Map} with pairs of keys and objects. The models
