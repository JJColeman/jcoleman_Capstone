...
/**
 * The {@link opennlp.tools.util.eval.Evaluator} is an abstract base class for evaluators.
 *
...
public abstract class Evaluator<T> {
   ...
   * {@link opennlp.tools.util.eval.Evaluator#processSample(Object)}
   * 
   * <p>
   * <b>note:</b> this method will be changed to private in the future.
   * Implementations should override {@link opennlp.tools.util.eval.Evaluator#processSample(Object)} instead.
