...
/**
 * The {@link opennlp.tools.util.StringList} is an immutable list of {@link String}s.
 */
public class StringList implements Iterable<String> {
   ...
   *
   * @param tokens the string parts of the new {@link opennlp.tools.util.StringList}, an empty
  ...
  /**
   * Retrieves an {@link java.util.Iterator} over all tokens.
   *
