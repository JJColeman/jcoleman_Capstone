...
/**
 * Utility class for handling of {@link opennlp.tools.ml.model.MaxentModel}s.
 */
public final class ModelUtil {
  ...
  /**
   * Writes the given model to the given {@link java.io.OutputStream}.
   *
  ...
  /**
   * Writes the provided {@link java.io.InputStream} into a byte array
   * which is returned
   * 
   * @param in stream to read data for the byte array from
   * @return byte array with the contents of the stream
   * 
   * @throws java.io.IOException if an exception is thrown while reading
   *     from the provided {@link java.io.InputStream}
   */
