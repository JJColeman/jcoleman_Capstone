...
public class Dictionary implements Iterable<StringList> {
  ...
  /**
   * Initializes an empty {@link opennlp.tools.dictionary.Dictionary}.
   */
  public Dictionary() {
    this(false);
  }
  ...
  /**
   * Initializes the {@link opennlp.tools.dictionary.Dictionary} from an existing dictionary resource.
   *
   * @param in
   ...
   *             {@link opennlp.tools.dictionary.Dictionary#Dictionary(java.io.InputStream)} instead and set the
   ...
   *
   * @return token-{@link java.util.Iterator}
   */
  ...
  /**
   * Writes the current instance to the given {@link java.io.OutputStream}.
   *
   * @param out
   * @throws java.io.IOException
   */
