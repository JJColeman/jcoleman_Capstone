...
/**
 * This classes indexes {@link opennlp.tools.util.StringList}s. This makes it possible
 * to check if a certain token is contained in at least one of the
 * {@link opennlp.tools.util.StringList}s.
 */
public class Index {
   ...
   * {@link opennlp.tools.util.StringList} {@link java.util.Iterator}.
   *
   * @param tokenLists
   */
  ...
  /**
   * Checks if at leat one {@link opennlp.tools.util.StringList} contains the
   * given token.
   *
   * @param token
   *
