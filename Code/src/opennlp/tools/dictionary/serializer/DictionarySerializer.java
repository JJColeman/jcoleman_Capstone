...
//    private boolean mIsInsideEntryElement;
  ...
  /**
   * Creates {@link Entry}s from the given {@link java.io.InputStream} and
   ...
   * @deprecated Use {@link opennlp.tools.dictionary.serializer.DictionarySerializer#serialize(java.io.OutputStream, java.util.Iterator, boolean)} instead
   */
  @Deprecated
