...
public class SDCrossValidator {
  ...
  /**
   * @deprecated Use
   *             {@link #SDCrossValidator(String, opennlp.tools.util.TrainingParameters, SentenceDetectorFactory, SentenceDetectorEvaluationMonitor...)}
  ...
  /**
   * @deprecated use {@link #SDCrossValidator(String, opennlp.tools.util.TrainingParameters, opennlp.tools.dictionary.Dictionary, SentenceDetectorEvaluationMonitor...)}
  ...
  /**
   * @deprecated use
   *             {@link #SDCrossValidator(String, opennlp.tools.util.TrainingParameters, opennlp.tools.dictionary.Dictionary, SentenceDetectorEvaluationMonitor...)}
   *             instead and pass in a TrainingParameters object.
   */
  public SDCrossValidator(String languageCode, TrainingParameters params,
      SentenceDetectorEvaluationMonitor... listeners) {
