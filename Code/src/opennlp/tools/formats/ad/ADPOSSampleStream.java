...
public class ADPOSSampleStream implements ObjectStream<POSSample> {
  ...
  private final ObjectStream<Sentence> adSentenceStream;
  private boolean expandME;
  private boolean isIncludeFeatures;

  /**
   * Creates a new {@link opennlp.tools.postag.POSSample} stream from a line stream, i.e.
   * {@link opennlp.tools.util.ObjectStream}< {@link String}>, that could be a
   * {@link opennlp.tools.util.PlainTextByLineStream} object.
   * 
   * @param lineStream
  ...
  /**
   * Creates a new {@link opennlp.tools.postag.POSSample} stream from a {@link java.io.InputStream}
   * 
   * @param in
   *          the Corpus {@link java.io.InputStream}
   * @param charsetName
