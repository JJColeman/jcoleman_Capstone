...
public class TokenNameFinderCrossValidator {
   ...
   * @param iterations
   * 
   * @deprecated use {@link #TokenNameFinderCrossValidator(String, String, opennlp.tools.util.TrainingParameters, byte[], java.util.Map, TokenNameFinderEvaluationMonitor...)}
  ...
  public void evaluate(ObjectStream<NameSample> samples, int nFolds)
    ...
    while (partitioner.hasNext()) {
      ...
      TokenNameFinderModel model  = NameFinderME.train(languageCode, type,
