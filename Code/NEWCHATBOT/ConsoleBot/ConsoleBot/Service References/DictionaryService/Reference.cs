...
namespace ConsoleBot.DictionaryService {
    ...
    public interface DictServiceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConsoleBot.DictionaryService.Dictionary[] DictionaryList();
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConsoleBot.DictionaryService.Dictionary[] DictionaryListExtended();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface DictServiceSoapChannel : ConsoleBot.DictionaryService.DictServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DictServiceSoapClient : System.ServiceModel.ClientBase<ConsoleBot.DictionaryService.DictServiceSoap>, ConsoleBot.DictionaryService.DictServiceSoap {
        ...
        public ConsoleBot.DictionaryService.Dictionary[] DictionaryList() {
            return base.Channel.DictionaryList();
        }
        
        public ConsoleBot.DictionaryService.Dictionary[] DictionaryListExtended() {
        ...
        public ConsoleBot.DictionaryService.WordDefinition Define(string word) {
            return base.Channel.Define(word);
        }
        
        public ConsoleBot.DictionaryService.WordDefinition DefineInDict(string dictId, string word) {
            return base.Channel.DefineInDict(dictId, word);
        }
        
        public ConsoleBot.DictionaryService.Strategy[] StrategyList() {
            return base.Channel.StrategyList();
        }
        
        public ConsoleBot.DictionaryService.DictionaryWord[] Match(string word, string strategy) {
            return base.Channel.Match(word, strategy);
        }
        
        public ConsoleBot.DictionaryService.DictionaryWord[] MatchInDict(string dictId, string word, string strategy) {
